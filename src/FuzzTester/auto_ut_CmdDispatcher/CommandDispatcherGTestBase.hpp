// ======================================================================
// \title  CommandDispatcherGTestBase.hpp
// \author Generated by fpp-to-cpp
// \brief  hpp file for CommandDispatcher component Google Test harness base class
// ======================================================================

#ifndef Svc_CommandDispatcherGTestBase_HPP
#define Svc_CommandDispatcherGTestBase_HPP
...
#define ASSERT_from_compCmdSend(index, _opCode, _cmdSeq, _args) \
  { \
    ASSERT_GT(this->fromPortHistory_compCmdSend->size(), static_cast<U32>(index)) \
      << "\n" \
      << __FILE__ << ":" << __LINE__ << "\n" \
      << "  Value:    Index into history of compCmdSend\n" \
...
#define ASSERT_from_pingOut(index, _key) \
  { \
    ASSERT_GT(this->fromPortHistory_pingOut->size(), static_cast<U32>(index)) \
      << "\n" \
      << __FILE__ << ":" << __LINE__ << "\n" \
      << "  Value:    Index into history of pingOut\n" \
      << "  Expected: Less than size of history (" \
...
#define ASSERT_from_seqCmdStatus(index, _opCode, _cmdSeq, _response) \
  { \
    ASSERT_GT(this->fromPortHistory_seqCmdStatus->size(), static_cast<U32>(index)) \
      << "\n" \
      << __FILE__ << ":" << __LINE__ << "\n" \
      << "  Value:    Index into history of seqCmdStatus\n" \
      << "  Expected: Less than size of history (" \
...
#define ASSERT_EVENTS_OpCodeRegistered(size, _Opcode, _port, _slot) \
  this->assertEvents_OpCodeRegistered(__FILE__, __LINE__, size, _Opcode, _port, _slot)

#define ASSERT_EVENTS_OpCodeDispatched_SIZE(size) \
  this->assertEvents_OpCodeDispatched_size(__FILE__, __LINE__, size)

#define ASSERT_EVENTS_OpCodeDispatched(size, _Opcode, _port) \
  this->assertEvents_OpCodeDispatched(__FILE__, __LINE__, size, _Opcode, _port)

#define ASSERT_EVENTS_OpCodeCompleted_SIZE(size) \
  this->assertEvents_OpCodeCompleted_size(__FILE__, __LINE__, size)

#define ASSERT_EVENTS_OpCodeCompleted(size, _Opcode) \
  this->assertEvents_OpCodeCompleted(__FILE__, __LINE__, size, _Opcode)

#define ASSERT_EVENTS_OpCodeError_SIZE(size) \
  this->assertEvents_OpCodeError_size(__FILE__, __LINE__, size)

#define ASSERT_EVENTS_OpCodeError(size, _Opcode, _error) \
  this->assertEvents_OpCodeError(__FILE__, __LINE__, size, _Opcode, _error)

#define ASSERT_EVENTS_MalformedCommand_SIZE(size) \
  this->assertEvents_MalformedCommand_size(__FILE__, __LINE__, size)

#define ASSERT_EVENTS_MalformedCommand(size, _Status) \
  this->assertEvents_MalformedCommand(__FILE__, __LINE__, size, _Status)

#define ASSERT_EVENTS_InvalidCommand_SIZE(size) \
  this->assertEvents_InvalidCommand_size(__FILE__, __LINE__, size)

#define ASSERT_EVENTS_InvalidCommand(size, _Opcode) \
  this->assertEvents_InvalidCommand(__FILE__, __LINE__, size, _Opcode)

#define ASSERT_EVENTS_TooManyCommands_SIZE(size) \
  this->assertEvents_TooManyCommands_size(__FILE__, __LINE__, size)

#define ASSERT_EVENTS_TooManyCommands(size, _Opcode) \
  this->assertEvents_TooManyCommands(__FILE__, __LINE__, size, _Opcode)
...
#define ASSERT_EVENTS_NoOpStringReceived(size, _message) \
  this->assertEvents_NoOpStringReceived(__FILE__, __LINE__, size, _message)

#define ASSERT_EVENTS_TestCmd1Args_SIZE(size) \
  this->assertEvents_TestCmd1Args_size(__FILE__, __LINE__, size)

#define ASSERT_EVENTS_TestCmd1Args(size, _arg1, _arg2, _arg3) \
  this->assertEvents_TestCmd1Args(__FILE__, __LINE__, size, _arg1, _arg2, _arg3)

#define ASSERT_EVENTS_OpCodeReregistered_SIZE(size) \
  this->assertEvents_OpCodeReregistered_size(__FILE__, __LINE__, size)

#define ASSERT_EVENTS_OpCodeReregistered(size, _Opcode, _port) \
  this->assertEvents_OpCodeReregistered(__FILE__, __LINE__, size, _Opcode, _port)
...
namespace Svc {
  ...
  //! \brief Auto-generated base for CommandDispatcher component Google Test harness
  class CommandDispatcherGTestBase :
